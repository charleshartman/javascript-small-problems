...
function searchWord(searchText, contentText) {
  const regex = new RegExp(`\\b${searchText}\\s`, 'gi');
  return contentText.replace(regex, `**${searchText.toUpperCase()}**`);
}


const text = 'Sed ut persedpiciatis unde omnis iste natus error sit voluptatem' +
...
// returns
/* "**SED** ut persedpiciatis unde omnis iste natus error sit voluptatem
